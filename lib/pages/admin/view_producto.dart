...
class ViewProducto extends StatefulWidget {
  ViewProducto({this.producto, this.idProducto, this.uid});
  final String idProducto;
  final String uid;
  final Producto producto;
  @override
  _ViewProductoState createState() => _ViewProductoState();
}

enum SelectSource { camara, galeria }

class _ViewProductoState extends State<ViewProducto> {
